...
Você terá 3 oportunidades de jogar novamente o jogo!!!!
...
${comp} decidiu não sair naquele dia, pois tinha alguns afazeres em casa mesmo.`);
    ...
    do{
    console.log();
    console.log(`OBS: escreva os nomes, com a primeira letra maiuscula!!!!`);
    console.log();
...
palpite();
console.log();
var fim = prompt(`Aperte enter para jogar novamente!  `);
console.clear();
}
console.log();
console.log(`SUAS CHANCES DE JOGADA ACABARAM!!!!`);
console.log();
var comprar = prompt(`Deseja mais chances para jogar? `);
console.clear();
} while (comprar != `nao`);